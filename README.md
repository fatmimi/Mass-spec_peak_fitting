...
This code has been applied on the following publication in order to accelerate the data processing efficiency of peak fitting and verified by the traditional method with [Origin](https://www.originlab.com).
